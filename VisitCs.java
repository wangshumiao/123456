...
public class VisitCs {
	...
	public void cs(String id) throws Exception{
		...
		strbuffer.append(id+",");
		System.out.println("欢迎来到安阳师范学院选课系统");
		System.out.println("以下为可选择的课程---任意选择三门学科");
		System.out.println("1--离散数学");
		System.out.println("2--概率论");
		System.out.println("3--大学英语");
		System.out.println("4--大学物理");
		System.out.println("5--Linux");
		System.out.println("6--面向对象程序设计");
